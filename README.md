...
![My Skills](https://skillicons.dev/icons?i=c,python,flask,django,mysql,ruby,html,css,js,ts,bootstrap,bash,linux,nginx,docker,vscode,vim,emacs,git,github&perline=10)
